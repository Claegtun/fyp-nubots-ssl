...
# Import the data.
r_data = np.loadtxt("./pyramid_robot/noise/logs/r.csv"  delimiter=',')
n_failures_data = np.loadtxt("./pyramid_robot/noise/logs/n_failures.csv"  delimiter=',')
...
plt.savefig("./pyramid_robot/noise/distance.png"  dpi = 512)
plt.show()
...
plt.savefig("./pyramid_robot/noise/azimuth.png"  dpi = 512)
plt.show()
...
plt.savefig("./pyramid_robot/noise/elevation.png"  dpi = 512)
plt.show()