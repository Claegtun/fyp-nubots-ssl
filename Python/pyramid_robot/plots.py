...
plt.savefig("./pyramid_robot/noise_distance.png", dpi = 512)
plt.show()
...
plt.savefig("./pyramid_robot/noise_azimuth.png", dpi = 512)
plt.show()
...
plt.savefig("./pyramid_robot/noise_elevation.png", dpi = 512)
plt.show()