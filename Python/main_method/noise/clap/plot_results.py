...
# Import the data.
data = np.loadtxt("./main_method/noise/clap/logs/angles.csv", delimiter=',')
...
plt.suptitle("The Simulated Error against Noise with a Clap")
fig.set_figheight(5)
fig.set_figwidth(8)
plt.subplots_adjust(wspace = 0.28)
plt.savefig("./main_method/noise/clap/plots.png", dpi = 1024)
plt.show()