...
# Import the data.
data = np.loadtxt("./main_method/noise/whistle/logs/angles.csv", delimiter=',')
...
plt.suptitle("The Simulated Error against Noise with a Whistle")
fig.set_figheight(5)
fig.set_figwidth(8)
plt.subplots_adjust(wspace = 0.28)
plt.savefig("./main_method/noise/whistle/plots.png", dpi = 1024)
plt.show()