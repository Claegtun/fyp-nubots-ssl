...
# Name the log files.
log_angles = "./main_method/delay/sampling/logs/angles.csv"
...
# For each noise-level, simulate the room and try to localise the source.
for i_noise in range(n_noises):
    ...
    for i_run in range(n_runs):
        ...
        # Upsample the original eightfold.
        ...
        # Stagger each channel and then downsample it back to the original rate.
